...
string McMitm::frame_to_str(const Dot11 &pkt){
	...
	static const unordered_map<int,string> mgmt_names = {
		{Dot11::BEACON, "Beacon"}, {Dot11::PROBE_REQ, "ProbeReq"}, {Dot11::PROBE_RESP, "ProbeResp"},
		{Dot11::AUTH, "Auth"}, {Dot11::DEAUTH, "Deauth"}, {Dot11::ASSOC_REQ, "AssoReq"},
		{Dot11::REASSOC_REQ, "ReassoReq"}, {Dot11::ASSOC_RESP, "AssoResp"}, {Dot11::REASSOC_RESP, "ReassoResp"},
		{Dot11::DISASSOC, "Disas"}, {13, "Action"},
	};
	...
	static const unordered_map<int,string> data_names = {
		{Dot11::DATA_DATA, "Data"}, {Dot11::DATA_NULL, "Null"}, {Dot11::QOS_DATA_DATA, "QoS-Data"},
		{Dot11::QOS_DATA_NULL, "QoS-Null"}, {Dot11::CF_ACK, "CF-Ack"}, {Dot11::CF_POLL, "CF-Poll"},
	};

	const auto *names = type == Dot11::MANAGEMENT
						? &mgmt_names
						: type == Dot11::CONTROL
						? &ctrl_names
						: type == Dot11::DATA
...
void McMitm::display_traffic(const PDU &pdu, const string &prefix, const string &suffix){
	...
	const bool is_null = data && (data->subtype() == Dot11::DATA_NULL || data->subtype() == Dot11::QOS_DATA_NULL);

	const auto level = is_eapol(pdu) || (dot11->type() == Dot11::DATA && !is_null) ? LogLevel::INFO : LogLevel::DEBUG;
