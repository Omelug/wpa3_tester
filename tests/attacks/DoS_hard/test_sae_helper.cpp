...
const vector<uint8_t> expected_scalar = { 0xcd,
	0x3a,
	0x57,
	0x89,
	0xa1,
...
const vector<uint8_t> expected_element = { 0xeb,
	0x90,
	0x1b,
	0xf1,
	0xf2,
...
TEST_CASE("ParsesCommitFromPcap") {
	path pcap_path = path(TEST_DATA_DIR) / "test_sae_commit.pcapng";
...
// ------------ bytes_to_hex tests ------------------
TEST_CASE("bytes_to_hex - empty vector") { CHECK_EQ(wpa3_tester::sae_helper::bytes_to_hex({}), "(empty)"); }
