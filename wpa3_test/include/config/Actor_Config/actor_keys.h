...
inline constexpr std::array<std::string_view, static_cast<size_t>(SK::COUNT_)> SK_NAMES = { "actor_name",
	"source",
	"iface",
	"mac",
	"permanent_mac",
...
constexpr std::string_view sk_name(SK k) { return SK_NAMES[static_cast<size_t>(k)]; }

constexpr std::string_view bk_name(BK k) { return BK_NAMES[static_cast<size_t>(k)]; }
