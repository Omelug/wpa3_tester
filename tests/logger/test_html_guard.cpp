...
struct HtmlFixture {
	path dir;
	explicit HtmlFixture(const string &name):
...
TEST_CASE("device() - device page at root -> returns relative link") {
	...
	CHECK_EQ(device(mac.to_string(), fx.dir), "<a href=\"devices/aa:bb:cc:dd:ee:ff/index.html\">aa:bb:cc:dd:ee:ff</a>");
}
...
static const string TOOLTIP_HDR = R"(<span class="tooltip-content"><table><tr><th>Value</th><th>Source</th></tr>)";
