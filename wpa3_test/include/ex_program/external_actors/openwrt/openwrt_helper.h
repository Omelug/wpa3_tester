...
std::string uci_get_option(const std::filesystem::path &uci_file,
...
std::string akm_from_openwrt_log(const std::filesystem::path &log_path, const Tins::HWAddress<6> &client_mac, TimeWindow window = {});
...
std::string mfp_from_openwrt_log(const std::filesystem::path &log_path, const Tins::HWAddress<6> &client_mac, TimeWindow window = {});
