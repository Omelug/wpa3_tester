...
// radiotap has two antennas with different dBm Antenna Signal readings
// (tshark shows -29, but Tins::RadioTap::dbm_signal() parses the other one: -28)
// -28 is what apply_radiotap() actually sees
...
// assoc_req.pcapng: real association request (subtype 0)
...
// same dual-antenna radiotap quirk as beacon_test.pcapng - tshark shows -44, Tins parses -27.
